...
app.layout = html.Div([
    ...
    html.H1(
        "Autonomous Driving Validation Dashboard"
    ),
    ...
    html.Div([
        ...
        html.H3(
            f"Lane Error: {lane_error:.3f}"
        ),

        html.H3(
            f"Min TTC: {ttc:.2f} sec"
        )
...
executive_summary = html.Div(
    ...
    [
        ...
        html.P(
            "Highest risk area: Emergency Braking"
        ),

        html.P(
            "Most common failure mode: Unsafe TTC"
        ),
...
planning_df = pd.read_csv(
    "data/raw/planning.csv"
)
