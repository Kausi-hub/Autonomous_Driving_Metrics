...
from scenario.failure_analysis import (
    top_failure_modes,
    risk_ranking,
...
detection_df = (
    loader.load_detection_data()
)

planning_df = (
    loader.load_planning_data()
)

control_df = (
    loader.load_control_data()
)
...
top_failures = top_failure_modes(
    scenario_results
)
...
print(
    f"{pass_rate_stats['lower']*100:.1f}% "
    f"to "
    f"{pass_rate_stats['upper']*100:.1f}%"
)
